...
contract PuppyRaffleTest is Test {
    ...
    function test_reentrancyRefund() public  {
        ...
        console.log("Starting attack contract balance: %s", startingAttackContractBalance);
        console.log("Starting contract balance: %s", startingContractBalance);
        console.log("Ending attack contract balance: %s", address(attackerContract).balance);
